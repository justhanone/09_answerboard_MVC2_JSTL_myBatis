	...
	<tr>
		<td colspan="2">
			...
			<input class="btn btn-primary" type="button" value="글목록" 
						onclick="location.href='boardlist.board?pnum=${pnum}'"/>
		</td>
	</tr>
</table>
		...
		<table class="table table-striped" border="1">
			<tr>
				...
				<td><input class="form-control" type="text" name="id"
					pattern="^[a-zA-Z0-9]+$" required="required" /></td>
			</tr>
			<tr>
				<th>글제목</th>
			...
			<tr>
				<td colspan="2">
					...
					<input class="btn btn-primary" type="button" value="글목록" onclick="location.href='boardlist.board?pnum=${pnum}'" />
				</td>
			</tr>
		</table>
	</form>
